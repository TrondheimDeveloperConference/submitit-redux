    ...
    (let [error-response (validate-input talk)]
      (if error-response error-response
        (let [talk-result (communicate-talk-to-ems talk session)]
          ...
          (send-mail (speaker-mail-list talk) (str "Confirmation " (if (exsisting-talk? talk) "on updating" "of") " your Trondheim Developer Conference 2017 submission \"" (talk "title") "\"") (generate-mail-text (slurp (clojure.java.io/resource "speakerMailTemplate.txt"))
